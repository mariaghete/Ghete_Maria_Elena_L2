...
namespace Ghete_Maria_Elena_L2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Ghete_Maria_Elena_L2Context context,
                                                                     Book book)
        {
            ...
            {
                bookCategories = new HashSet<int>(
        ...
        public void UpdateBookCategories(Ghete_Maria_Elena_L2Context context,
        string[] selectedCategories, Book bookToUpdate)
        {
            if (selectedCategories == null)
            {
                bookToUpdate.BookCategories = new List<BookCategory>(); return;
            }
